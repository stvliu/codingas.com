// 文档频道侧边栏数据：单一来源（.mjs 供 Node 脚本直接 import）。
// astro.sidebar.ts 对其 re-export 供 astro.config.ts 使用；
// scripts/export-wiki.mjs 读取同一份生成 Gitee/GitHub Wiki 的 _Sidebar.md。
// 5 大分组，管理员/开发者双视角分轨。全部条目均渲染（不做条件隐藏）。
