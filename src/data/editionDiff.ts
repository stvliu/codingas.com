...
export const editionDiff: DiffCategory[] = [
  {
    ...
    items: [
      ...
      { name: '图像生成端点（/v1/images/generations）', standard: false, enterprise: true },
      { name: '语音合成端点（/v1/audio/speech）', standard: false, enterprise: true },
      { name: '语音识别端点（/v1/audio/transcriptions）', standard: false, enterprise: true },
      { name: '内容审核端点（/v1/moderations）', standard: false, enterprise: true },
    ],
  },
  {
    ...
    items: [
      ...
      { name: '多 Key 管理（自动轮换、调度、故障切换）', false: true, enterprise: true },
      { name: '默认 Key 设置', standard: false, enterprise: true },
      { name: 'Key 统计展示', standard: true, enterprise: true },
      { name: '负载均衡（优先级 + 权重）', standard: false, enterprise: true },
      { name: '渠道分组', standard: false, enterprise: true },
      { name: '渠道级故障转移', standard: false, enterprise: true },
      { name: '熔断超时（防雪崩）', standard: false, enterprise: true },
  ...
  },
  {
    category: '路由',
    items: [
      { name: '模型级智能降级', standard: false, enterprise: true },
      { name: '场景路由（CODE/CREATIVE/SUMMARY 等）', standard: false, enterprise: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'OAuth 登录（GitHub、Gitee、QQ、企业微信）', standard: false, enterprise: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '额度限制', standard: false, enterprise: true },
      { name: '模型白名单', standard: false, enterprise: true },
      { name: 'IP 限制', standard: false, enterprise: true },
      { name: '过期时间', standard: false, enterprise: true },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Token 限额（用户级/API Key 级）', standard: false, enterprise: true },
  ...
  },
  {
    category: '安全与风控',
    items: [
      { name: '认证中间件（Token 验证）', standard: false, enterprise: true },
      { name: 'IP 白/黑名单', standard: false, enterprise: true },
      { name: 'UA 过滤', standard: false, enterprise: true },
      { name: 'PII 脱敏（手机号、身份证、邮箱、银行卡等）', standard: false, enterprise: true },
      { name: '数据掩码策略', standard: false, enterprise: true },
      { name: '审计日志', standard: false, enterprise: true },
      { name: '密钥加密存储（AES-256）', standard: false, enterprise: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '结构化日志（JSON 格式）', standard: false, enterprise: true },
